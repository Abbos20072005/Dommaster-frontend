...
export const SuggestionView = ({ searchValue }: Props) => {
    ...
    <div className='grid grid-cols-2'>
            ...
            {Array.from({ length: 5 }).map((_, i) => (
              <li key={i} className='flex'>
                <Link
                  ...
                  className='hover:bg-muted flex flex-1 items-center gap-2 rounded-md px-4 py-2.5 transition-colors'
                >
          ...
          <ul>
            {Array.from({ length: 5 }).map((_, i) => (
              <li key={i}>
                <Link
                  href={`search?query=${searchValue}`}
                  className='hover:bg-muted block rounded-md px-4 py-2.5 transition-colors'
                >
                  <span className='text-sm'>value {i + 1}</span>
                </Link>
              </li>
      ...
      <div className='p-3'>
        {Array.from({ length: 5 }).map((_, i) => (
          ...
          >
            <Link href='product/1' className='shrink-0'>
              <Image
                src={
                  'data:image/jpeg;base64,'
                }
            ...
            <div className='space-y-1'>
              ...
              <Link href='product/1' className='block'>
                <p className='text-xs'>Арматура композитная стеклопластиковая 8 мм 1 м синяя</p>
              </Link>
              <div className='flex items-center justify-between'>
                <span className='text-sm font-bold'>34 000 UZB</span>
                <Button
